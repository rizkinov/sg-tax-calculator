      ...
      {result && (
        <div className="mt-8 space-y-4">
          ...
          <div className="p-4 border rounded">
            <p className="font-bold">Total Tax: SGD {result.totalTax.toFixed(2)}</p>
          </div>
          ...
          <div className="space-y-2">
            ...
            {result.breakdown.map((item, index) => (
              <div key={index} className="p-2 border rounded text-sm">
                ...
                <p>Taxable Amount: SGD {item.taxableAmount.toFixed(2)}</p>
                <p>Tax: SGD {item.taxForBracket.toFixed(2)}</p>
              </div>
            ))}
          </div>
        </div>
